          ...
          <div className="config-card">
            ...
            <label className="config-label">
              ...
              <input
                ...
                onChange={(e) =>
                  updateUpstream("root_server_ip", e.target.value)
                }
              />
            </label>
            <label className="config-label">
              ...
              <input
                ...
                className="config-input"
                value={
                  (config as ResolverConfigFormat).upstream.root_server_port ||
                  53
                }
                onChange={(e) =>
                  updateUpstream(
          ...
          <div className="config-card">
            ...
            <label className="config-label">
              ...
              <input
                ...
                className="config-input"
                value={
                  (config as ResolverConfigFormat).storage.cache_file || ""
                }
            ...
            <label className="config-label">
              ...
              <input
                ...
                className="config-input"
                value={
                  (config as ResolverConfigFormat).storage.cache_capacity ||
                  1000
                }
                onChange={(e) =>
                  updateStorage(
