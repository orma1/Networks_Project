...
if (Test-Path "Server_Proxy") {
    ...
    $processes += Start-Process python -ArgumentList "app_server.py" -PassThru -NoNewWindow
    $processes += Start-Process python -ArgumentList "app_proxy.py" -PassThru -NoNewWindow
