...
if (Test-Path "Server_Proxy") {
    ...
    $processes += Start-Process python -ArgumentList "unified_server2.py" -PassThru -NoNewWindow
    $processes += Start-Process python -ArgumentList "unified_proxy2.py" -PassThru -NoNewWindow
